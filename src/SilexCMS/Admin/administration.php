...
$app->match('/administration/{table}', function (Application $app, Request $req, $table) {
    ...
    return new TransientResponse($app['twig'], $app['silexcms.template.loader']->load('administration/administration_table.html.twig'), array('table' => $table, 'fields' => $schema, 'rows' => $data));
})
...
$app->match('/administration/{table}/{id}', function (Application $app, Request $req, $table, $id) {
    ...
    return new TransientResponse($app['twig'], $app['silexcms.template.loader']->load('administration/administration_edit.html.twig'), array(
        'table' => $table,
        'id'    => $id,
...
$app->match('/administration', function(Application $app, Request $req) {
    ...
    return new TransientResponse($app['twig'], $app['silexcms.template.loader']->load('administration/administration_hub.html.twig'), array('tables' => $listTables));
})
